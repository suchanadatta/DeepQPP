/*
 * Performs initial retrieval for each query and repares initial result file
...
public class InitialRetrieval {
    ...
    GenerateHistogramPrerankFile ghpf;
    
    
    public InitialRetrieval(GenerateHistogramPrerankFile ghpf) throws IOException {
